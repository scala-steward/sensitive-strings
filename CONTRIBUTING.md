...
Discussion around _sensitive-strings_ happens in the [GitHub issues](https://github.com/scala-steward/sensitive-strings/issues) and [pull requests](https://github.com/scala-steward/sensitive-strings/pulls).

Feel free to open an issue if you notice a bug, have an idea for a feature, or have a question about
the code. Pull requests are also welcome.

People are expected to follow the [Code of Conduct](CODE_OF_CONDUCT.md) when discussing _sensitive-strings_ on the Github page or other venues.
...
_sensitive-strings_ follows a standard [fork and pull](https://help.github.com/articles/using-pull-requests/) model for contributions via GitHub pull requests.
